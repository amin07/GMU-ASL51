...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(127, 331);
			...
			this->label1->Location = System::Drawing::Point(43, 334);
			...
			this->recordOptions->Location = System::Drawing::Point(131, 58);
			...
			this->displayOptions->Location = System::Drawing::Point(130, 128);
			...
			// startStopButt
			// 
			this->startStopButt->BackColor = System::Drawing::Color::SteelBlue;
			//this->startStopButt->ForeColor = System::Drawing::Color::Black;
			this->startStopButt->Location = System::Drawing::Point(24, 394);
			this->startStopButt->Name = L"startStopButt";
			this->startStopButt->Size = System::Drawing::Size(123, 62);
			this->startStopButt->TabIndex = 5;
			this->startStopButt->Text = L"START_REC";
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(128, 297);
			...
			this->label5->Location = System::Drawing::Point(38, 281);
			...
			this->label6->Location = System::Drawing::Point(95, 281);
			...
			this->groupBox1->Location = System::Drawing::Point(131, 197);
			...
			this->label4->Location = System::Drawing::Point(46, 220);
			...
			this->label8->Location = System::Drawing::Point(46, 361);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(127, 357);
			...
			// flagButton
			// 
			this->flagButton->Anchor = static_cast<System::Windows::Forms::AnchorStyles>((((System::Windows::Forms::AnchorStyles::Top | System::Windows::Forms::AnchorStyles::Bottom)
				| System::Windows::Forms::AnchorStyles::Left)
				| System::Windows::Forms::AnchorStyles::Right));
			this->flagButton->BackColor = System::Drawing::Color::MediumSeaGreen;
			this->flagButton->Cursor = System::Windows::Forms::Cursors::Hand;
			this->flagButton->Location = System::Drawing::Point(153, 394);
			this->flagButton->Margin = System::Windows::Forms::Padding(10);
			this->flagButton->Name = L"flagButton";
			this->flagButton->Size = System::Drawing::Size(126, 62);
			this->flagButton->TabIndex = 19;
			this->flagButton->Text = L"PUT START FLAG";
			
			//this->flagButton->Font = System::Drawing::Font(this->flagButton.Font.Name, 15, this->flagButton.Font.Style, this->flagButton.Font.Unit);
			this->flagButton->UseVisualStyleBackColor = false;
			this->flagButton->Click += gcnew System::EventHandler(this, &Form1::flagButton_Click);
			this->flagButton->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &Form1::OnKeyPressScale);
			this->flagButton->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &Form1::flagButton_MouseDown);
			this->flagButton->MouseLeave += gcnew System::EventHandler(this, &Form1::flagButton_MouseLeave);
			this->flagButton->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &Form1::flagButton_MouseUp);
			// 
			// Form1
			// 
...
#pragma endregion
	...
	private: System::Void StartStop(System::Object^  sender, System::EventArgs^  e) {
		...
		if (m_bRunMainLoop)
		{
			this->startStopButt->Text = L"STOP_REC";
			//this->startStopButt->ForeColor = System::Drawing::Color::DarkRed;
			this->startStopButt->BackColor = System::Drawing::Color::RosyBrown;
			...
			//cout << m_bSaveRGB << " " << m_bSaveDepth << " " << m_bSaveBody << endl;
	...
	private: System::Void flagButton_Click(System::Object^  sender, System::EventArgs^  e) {
		std::cout << "putting flags" << endl;
		m_bRunFlagLoop = !m_bRunFlagLoop;
		if (m_bRunFlagLoop == true) {
			this->flagButton->BackColor = System::Drawing::Color::IndianRed;
			this->flagButton->Text = L"PUT END FLAG";
			fprintf(m_fpSkel, "start\n");
		}
		else {
			this->flagButton->BackColor = System::Drawing::Color::MediumSeaGreen;
			this->flagButton->Text = L"PUT START FLAG";
			fprintf(m_fpSkel, "end\n");
		}
	...
	private: void InitState()
	{
		...
		strcpy(cpFullDirectPath, cpRootDirect);
...
private: System::Void flagButton_MouseDown(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
	//this->flagButton->BackColor = System::Drawing::Color::IndianRed;
}
private: System::Void flagButton_MouseLeave(System::Object^  sender, System::EventArgs^  e) {
	
}
private: System::Void flagButton_MouseUp(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
	//this->flagButton->BackColor = System::Drawing::Color::SlateBlue;
}
};
}
